...
function App() {
  ...
  const [idUser, setIdUSer] = useState(6);
  ...
  const getRandomCard = async (idUser) => {
    let url = URL_API + "/random-card/" + idUser;
    await fetch(url)
  ...
  return (
    <div className=" min-h-screen bg-slate-800">
      ...
      {isOpenCard && (
        <div className="max-w-sm mx-auto my-6 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          {typeCard == "question" && (
            <svg
